...
def tot_ut_multiple_sks_quick(sks, k0, l0, n, b, weight, theta, alpha, delta):
    '''
    ...
    return total_utility(y_short*(1-sks)/l_short, weight, theta)

def optimal_sks(t, b, l0, n, weight, delta, alpha, theta, k0, first=True):
    obj = lambda sks: -tot_ut_multiple_sks_quick(sks, k0, l0, n, b, weight, theta, alpha, delta)
